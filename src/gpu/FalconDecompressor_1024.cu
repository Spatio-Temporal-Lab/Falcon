...
#include "FalconDecompressor_1024.cuh"
#include <vector>
#include <cmath>
#include <cstdint>
#include <cstring>
...
void FalconDecompressor_1024::decompress(const std::vector<unsigned char>& compressedData, std::vector<double>& output, int numDatas) {
...
void FalconDecompressor_1024::Falcon_decompress(double* d_decData, unsigned char* d_cmpBytes, size_t nbEle, size_t cmpSize, cudaStream_t stream) {
...
void FalconDecompressor_1024::Falcon_decompress_stream_optimized(double* d_decData,
...
// 主机端实现 - 采用您建议的逻辑
void FalconDecompressor_1024::Falcon_decompress_no_pack(double* d_decData,
                                     unsigned char* d_cmpBytes,
                                     size_t nbEle,
                                     size_t cmpSize,
                                     cudaStream_t stream) {
