...
// // 静态定义 CDF 解压缩函数
// static Falcondecompress_1024_data_gdf(const std::vector<unsigned char>& cmpData, std::vector<double>& decompressedData, size_t nbEle) {
