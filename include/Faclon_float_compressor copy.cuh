...
#define MAX_NUMS_PER_CHUNK 1024*1024*4
...
public:
    ...
    // 分离位打包
    static void GDFC_compress_no_pack(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, cudaStream_t stream);
    // 暴力计算
    void GDFC_compress_br(float* d_oriData, unsigned char* d_cmpBytes, size_t nbEle, size_t* cmpSize, cudaStream_t stream);
