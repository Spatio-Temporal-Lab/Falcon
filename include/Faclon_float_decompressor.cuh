...
// cuCompressor/include/Faclon_float_decompressor.cuh
//
#include <vector>
#include <cmath>
#include <cstdint>
...
public:
    void GDFC_decompress(float* d_decData, unsigned char* d_cmpBytes, size_t nbEle, size_t cmpSize, cudaStream_t stream);
    ...
    void decompress_nopack(const std::vector<unsigned char>& compressedData, std::vector<float>& output) ;
